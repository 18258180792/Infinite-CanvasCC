...
const RECOMMENDED_APIS = [
    ...
    },
    {
        ...
        // APIMART/Comfly 的 Gemini 图片模型走 /v1/images/generations；
        // -2k 的原生 Gemini 路由仅在实际 api.apimart.ai Base URL 下使用。
        image_models:['seedream-v5-pro', 'gpt-image-2', 'gemini-3.1-flash-image-preview', 'nano-banana-pro-4k'],
        model_protocols:{}
    },
    {
        id:'lingjing',
...
function normalizeImageRequestMode(value){
    ...
    return ['openai', 'openai-json', 'openai-video-proxy', 'openai-responses', 'tudou-async', 'grsai'].includes(mode) ? mode : 'openai';
}
...
function imageRequestModeLabel(mode){
    ...
    if(normalized === 'grsai') return 'Grsai 原生接口';
    return 'OpenAI 标准';
}
